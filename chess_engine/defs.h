...
#define CLRBIT(bb, sq) ((bb) &= ClearMask[(sq)]) //Sets every bit but the current index to 1
#define SETBIT(bb, sq) ((bb)  |= SetMask[(sq)])//Sets every bit but the current index to 0
